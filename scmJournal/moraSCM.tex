...
%\usepackage[english]{babel} %For the tables
...
Takayuki~Kanda,
and~Norihiro~Hagita
\\\IEEEmembership{Advanced Telecommunications Research Institute International, ATR}
% \\2-2-2 Hikaridai, Keihanna Science City,
%\\Kyoto, Japan, 619-0288,
%\\\{andresmora, dylan, kanda, ishiguro, hagita\}@atr.jp}% <-this % stops a space
\thanks{A. Mora, D. Glas, T. Kanda and N. Hagita are with the Advanced Telecommunications Research Institute International
2-2-2 Hikaridai, Keihanna Science City, Kyoto, Japan, 619-0288, e-mail: amoravar@asu.edu}% <-this % stops a space
...
% The paper headers
\markboth{Journal of System, Man, and Cybernetics,~Vol.~X, No.~Y, XYZ~2011}%
...
\begin{IEEEkeywords}
spatial relationships, workload, teleoperation, social mobile robot.
\end{IEEEkeywords}
...
\IEEEPARstart{M}{o}bile social robots are expected to be used in human environments everyday environments such as malls, elderly care centers, museums, etc.
%{M}{o}bile social robotics is the field of robotics that deals with interacting with humans in everyday environments such as malls, elderly care centers, museums, etc.
...
% These drawbacks include an unintended disorienting side effect on the operator which reduced the operator's awareness of the state of the robot and thus could not use the video information effectively for navigational purposes. This reduced awareness is due to the increased attention the operator gives to the video presenting the customer's face which results in a lower understanding of the location and orientation of the robot within its environment, and the locations of objects and people around the robot.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \section{System awareness requirements}
% The identification of the key elements that affect the operator within the context of a teleoperated system for mobile robots is an important aspect during the design of such systems.
% 
% A classification presented by \cite{drury:decomposition}, proposes a set of situational awareness requirements for systems supporting humans in three different roles regarding unmanned aerial vehicles (UAVs). 
% The motivation of their classification is to provide recommendations to improve existing user interfaces that do not provide sufficient awareness on any of their proposed categories.
% Although their classification includes some of the general requirements of a teleoperated of mobile robot system, it does not cover the requirements that characterize the teleoperation of mobile social robots (MSR). 
% 
% In Table \ref{tab:comparison} we present a categorization of the different awareness components required by an operator during the teleoperation of mobile social robots. 
% Our proposed categorization is divided in four major branches: the mission or task of the robot, the state of the robot, the understanding the operator should have about the environment where the robot is located and the comprehension the operator should have with regards to the interaction the robot is engaging.
% 
% The ``social understanding'' category covers the components the operator should be aware of during an interaction with a customer.
% These components should be presented to the operator to allow the operator to have a smooth interaction with customers.
% Due to the mobile characteristic of this type of social robots, the location and social context in which they may be involved change constantly and dynamically.
% Therefore to provide a wider, more general categorization the components proposed for this particular category are independent of this location or social context.
% 
% In the approach presented in this paper, we have designed a system that complies with the components proposed in Table \ref{tab:comparison}.
% Our study focuses mainly on how to increase the social understanding of the operator by decreasing the workload of the operator using a shared autonomy technique and enhanced representation of spatial relationships thus facilitating the operation of the robot.
% 
% \begin{table*}
% \caption{A comparison of the different awareness components required in UAV robots and mobile social robots}
% \label{tab:comparison}
% \begin{tabular}{|c|c|c|c|}
% \hline
%  Category&Category Description&Awareness Component UAV & Awareness Component M.S.R. \\ 
% \hline
% 
% \multirow{10}{*}{Mission/Task} &
% \multirow{8}{4cm}{Operator should know the overall goal, but needs to know basically the own current task and potentially future tasks}
% & \multirow{2}{*}{UAVs’ missions} & \multirow{2}{*}{Robot service goals} \\
% & & & \\ \cline{3-4}
% & & \multirow{2}{*}{Progress towards completing the missions} 
% & \multirow{2}{*}{Progress towards completing the service goals} \\ 
% & & & \\ \cline{3-4}
% & & \multirow{4}{*}{Logic used by the UAVs} 
% & \multirow{4}{4.5cm}{Interaction logic of the robot, e.g. continues patrolling because interaction finished} \\ 
% & & & \\
% & & & \\
% & & & \\ \cline{3-4}
% & 　& \multirow{2}{*}{UAV aircraft identities (which one is which)} 
% & \multirow{2}{*}{Robot identity}\\
% & & & \\ 
% \hline
%  
% \multirow{5}{*}{Robot State} &
% \multirow{4}{4cm}{Robot identities, general health and status (talking, moving, etc)}
% & \multirow{2}{*}{Health of the UAVs} & \multirow{2}{*}{Health of the robot, e.g battery level}\\ 
% & & & \\ \cline{3-4}
% & & \multirow{3}{*}{Status of the UAVs} 
% & \multirow{3}{4.5cm}{Status of the robot, e.g. moving, talking, current robot's gestures}\\ 
% & & & \\
% & & & \\
% \hline
% 
% \multirow{10}{1.7cm}{Environment Understanding} &
% \multirow{10}{4cm}{Current and predicted 3D spatial relationships between  robots and obstacles, other robots, people}
% & \multirow{4}{4.5cm}{Current 3D spatial relationships between the UAVs and points on the Earth, other aircraft, terrain, targets}
% & \multirow{4}{4.5cm}{Current 3D spatial relationships between robots and obstacles, other robots, human bystanders} \\  
% & & & \\
% & & & \\
% & & & \\ \cline{3-4}
% & & \multirow{4}{4.5cm}{Predicted future 3D spatial relationships between the UAVs and other objects}
%   & \multirow{4}{4.5cm}{Predicted 3D spatial relationships between robots and obstacles, other robots, human bystanders} \\
% & & & \\
% & & & \\
% & & & \\ \cline{3-4}
% & & \multirow{2}{*}{Weather near the UAVs} & \multirow{2}{*}{Conditions near robots, e.g. rush hour} \\
% & & & \\ \cline{3-4}
% & & \multirow{2}{*}{Operational threats to the UAVs} & \multirow{2}{*}{N/A}\\
% & & & \\
% \hline
% 
% \multirow{18}{1.7cm}{Social Understanding} &
% \multirow{18}{4cm}{Procedures that enable an operator to interact smoothly with different customers independently of their ``social context''}
% & \multirow{2}{*}{N/A}
% & \multirow{2}{*}{Customer's attribution, e.g, gender, age} \\ 
% & & & \\ \cline{3-4}
% & & \multirow{3}{*}{N/A} & \multirow{4}{4cm}{Customer's internal state, e.g. customer's intention and waiting time?} \\
% & & & \\
% & & & \\
% & & & \\ \cline{3-4}
% & & \multirow{2}{*}{N/A} & \multirow{2}{*}{Location of people around the robot} \\ 
% & & & \\ \cline{3-4}
% & & \multirow{2}{*}{N/A} & \multirow{2}{*}{Audio from customer speech} \\
% & & & \\ \cline{3-4}
% & & \multirow{2}{*}{N/A} & \multirow{2}{*}{Customer's gestures and expressions} \\
% & & & \\ \cline{3-4}
% & & \multirow{3}{*}{N/A} & \multirow{4}{4cm}{Robot's position with respect to the customer, e.g. appropriate social distance} \\ 
% & & & \\
% & & & \\
% & & & \\ \cline{3-4}
% & & \multirow{4}{*}{N/A} & \multirow{5}{4cm}{Robot's orientation with respect to the customer, e.g. facing a customer or facing an object of shared attention} \\
% & & & \\
% & & & \\
% & & & \\
% & & & \\ 
...
\begin{figure}[htp]
\centering
\includegraphics[width=1\columnwidth, scale= 0.6]{figs/andres_screencap2.eps}
...
%It is expected that the proposed automatic gaze control by itself would not contribute.
...
%However, if the proposed automatic gaze control is combined with an appropriate representation of the spatial relationships of the environment, a positive effect should be observed.
%We expect that an operator will be less overwhelmed (thus, lower workload), more efficient and responsive in teleoperation (shorter interaction), which would result in overall better satisfaction of the customer.

%In addition, the combination of these two factors should decrease the time the operator spends looking for a given watch or the customer, thus reducing the overall interaction time. 
...
%\end{itemize}
%The combination of the visualization of spatial relationships factor and the automatic gaze control factor is expected to result in the highest level of customer satisfaction, present the lowest level of workload, and the shorter interaction times.
%On the other hand, not having either the visualization of spatial relations factor and automatic gaze control factor should result in the lowest level of customer satisfaction, present the highest level of workload, and the longest interaction times.
...
% In addition, to avoid the participants' learning effect of any given spatial configuration in one condition to influence another, after each trial, the layout (positions of the objects) in the robot's environment were changed to have different layouts.
% There are four layouts prepared in advance, which are made to be equivalent in navigation difficulty.
...
%The results of these techniques are summarized in Figure~\ref{fig:results}.
\begin{itemize}
  ...
  %\item After each condition, evaluations from the customer participants were provided to score on a 7-point Likert scale asking ``how satisfactory was the robot's service?'', i.e. {\bf customer satisfaction}. In this scale, higher values represent higher satisfaction.
  ...
  %In the context of this study, lower workload represents a more focused, efficient operator.
  ...
  %In our study, longer interactions are regarded as inefficient since they represent a ``bored'' customer.
...
%In order to understand what elements of the system may have influenced the human-robot interaction during the experiment, an analysis was made based on the video data obtained from the location of the robot and the screen of the operator.
...
%All four conditions of the experiment (NOP+NA, NOP+A, OP+NA and OP+A) were present in both the top and bottom 25\% of the video data.
...
%The four behavior categories that showed this pattern are detailed as follows and illustrated in Figure \ref{fig:highVsLow}:
% From the multiple behavior categories studied from the top and bottom ends where the number of ``bad'' interaction events registered was larger than the number of ``good'' interaction events were selected for this qualitative analysis. 
% The four behavior categories that presented the highest number of events observed during high and low customer satisfaction cases and thus may have strongly influenced the customer satisfaction are:
...
% \begin{itemize}
%   \item [a)] {\bf Robot fails to lead interaction.} 
%   Robot does not face the object the customer is interested in but the customer.
%   The robot stands near the customer and responds with short answers to the customer.
%   This behavior may affect the smoothness of the interaction with the customer since the customer realizes s/he is interacting with an ``answering machine" and not with a social mobile robot.  
%   An example of this category is the event ``the robot provides very few suggestions and is mostly just responding to questions.''
%   This may show an effect of how busy the operator may be, particularly looking for the locations of objects and watches inside the simulated store while trying to keep the customer interested.

% \begin{table*}[ht]
%  \caption{Behavior categories used to analyze video data}
%  \label{tab:behaviorCategory}
% \centering
% \begin{tabular}{|c|c|c|c|c|c|c|} 
% \hline
%  \multirow{4}{*}{Customer Satisfaction}&\multirow{4}{*}{Condition} & \multirow{4}{3cm}{Number of Videos Analyzed per Condition} & \multicolumn{4}{|c|}{Number of Behavior Occurences Observed per Category}\\ \cline{4-7}
%  
% & & & \multirow{2}{*}{Category a} & \multirow{2}{*}{Category b} & \multirow{2}{*}{Category c} & \multirow{2}{*}{Category d} \\
% & & & & & &\\ \cline{1-7}
% 
% \multirow{8}{*}{High CS Score} & \multirow{2}{*}{NOP+NA} & \multirow{2}{*}{1} & \multirow{2}{*}{0} & \multirow{2}{*}{0} & \multirow{2}{*}{0} & \multirow{2}{*}{0} \\
% & & & & & &\\ \cline{2-7}
% 
% & \multirow{2}{*}{NOP+A} & \multirow{2}{*}{4} & \multirow{2}{*}{0} & \multirow{2}{*}{0} & \multirow{2}{*}{3} & \multirow{2}{*}{2} \\
% & & & & & &\\ \cline{2-7}
% 
% & \multirow{2}{*}{OP+NA} & \multirow{2}{*}{2} & \multirow{2}{*}{0} & \multirow{2}{*}{0} & \multirow{2}{*}{2} & \multirow{2}{*}{1} \\
% & & & & & &\\ \cline{2-7}
% 
% & \multirow{2}{*}{OP+A} & \multirow{2}{*}{5} & \multirow{2}{*}{0} & \multirow{2}{*}{1} & \multirow{2}{*}{3} & \multirow{2}{*}{2} \\
% & & & & & &\\ \cline{1-7}
% 
% \multirow{8}{*}{Low CS Score} & \multirow{2}{*}{NOP+NA} & \multirow{2}{*}{3} & \multirow{2}{*}{3} & \multirow{2}{*}{3} & \multirow{2}{*}{3} & \multirow{2}{*}{2} \\
% & & & & & &\\ \cline{2-7}
% 
% & \multirow{2}{*}{NOP+A} & \multirow{2}{*}{6} & \multirow{2}{*}{3} & \multirow{2}{*}{4} & \multirow{2}{*}{6} & \multirow{2}{*}{4} \\
% & & & & & &\\ \cline{2-7}
% 
% & \multirow{2}{*}{OP+NA} & \multirow{2}{*}{4} & \multirow{2}{*}{1} & \multirow{2}{*}{1} & \multirow{2}{*}{4} & \multirow{2}{*}{3} \\
% & & & & & &\\ \cline{2-7}
% 
% & \multirow{2}{*}{OP+A} & \multirow{2}{*}{1} & \multirow{2}{*}{1} & \multirow{2}{*}{0} & \multirow{2}{*}{1} & \multirow{2}{*}{1} \\
% & & & & & &\\ \cline{2-7} 
% \hline
% \end{tabular}
% \end{table*}

%   \item [b)] {\bf Operator is disoriented.}
%   From the customer's perspective, the robot seems to have no understanding of the location of objects like the watches and/or the customer. This lack of understanding forces the operator to look for these objects making the robot move in a socially awkward manner.
%    An example of this category is the event ``the robot does not approach the customer when the customer enters the shop''. 
%   This category is an example of the necessity for the visualization of spatial relationships of the environment.
%   Without an intuitive representation of the environment the operator must spend a longer time understanding where objects are and how to safely navigate the robot. 
% 
%   \item [c)] {\bf Customer ignores the robot.}
%   The customer may be interested on a watch that is different from that the robot is suggesting at a given moment. The customer moves to look at a watch other than the one the robot is suggesting. 
%   An example of this category is the event ``the customer takes the initiative in moving to another watch, instead of the robot''.
%   Although this may be normal in certain occasions, it may also be a sign that the operator is taking a long time to observe the gestures of the customer and provide a good recommendation on a watch upon such observation.
% It may also reflect how the operator is busy trying to recognize a given watch and point to it or direct the customer to it while the customer is already interested in another watch.
%   
%   \item [d)] {\bf Customer is bored.}
%   The customer starts looking around or holds his/her head waiting for the robot to respond. 
%   An example of this category is the event ``the customer seems bored and is not engaged in the interaction with the robot nor looking at the watch at hand''. 
%   The operator is not aware of the locations of the different objects in the environment and therefore continouosly looks for them.
%   The time the operator spends on searching for a particular object is long enough to make the customer loose interest in the interaction and becomes bored.
% \end{itemize}

% Table \ref{tab:behaviorCategory} summarizes the behavior categories used to analyze the interactions between the robot and the customer in the following manner.
% Two main groups, ``High CS Score'' and ``Low CS Score'' representing the top and bottom ends of customer satisfaction score data, are subdivided into the four conditions of the experiment. 
% ``CS'' in this case means customer satisfaction.
% 
% The table shows the total number of videos analyzed per experimental condition followed by the total number of occurences of the behavior categories for that specific experimental condition.
% For example, the experimental condition NOP+NA had one instance with high customer satisfaction score and none of the analyzed behavior categories were observed.
% The experimental condition NOP+A presented 6 instances with low customer satisfaction with a total of 3 occurences for category ``a'' behaviors, 4 for category ``b'' behaviors, 6 for category ``c'' behaviors and 4 for category ``d'' behaviors.
% The events that were observed for each analyzed behavior category on both the high and low customer satisfaction score cases were added and for comparision purposes these values were normalized within a range between 0 and 1.

% Some of the phenomena observed during the video analysis included: 
% \begin{itemize}
%   \item [a)] ``The robot provides very few suggestions and is mostly just responding to questions''. 
%   Operator reminds merely reactive giving the customer the impression that is only interacting with a machine and not with a social mobile robot.
% 
%   \item [b)] ``The robot does not approach the customer when the customer enters the shop''.
% The operator is not aware of the presence of a new customer in the store and the customer may wonder around for enough time to make the customer feel alone or unattended, thus lowering his/her satisfaction of the service.
% 
%   \item [c)] ``The customer takes the initiative in moving to another watch, instead of the robot''.
% If the operator is not aware of the presence of the customer, the customer may take the initiave and look around for a watch. 
% 
%   
%   \item [d)] ``The customer seems bored, s/he is not engaged in the interaction with the robot nor looking at the watch at hand''.
% The operator fails in having an interaction whereby the robot greets and moves towards the customer as soon as s/he enters the shop.
% \end{itemize}

% To carry out the video analysis, the data was equally divided in four main groups and organized in a descendent order from highest to lowest according to customer satisfaction scores.
% For the scope of this paper, only the top and bottom 25\% of these data was analyzed.


%The results obtained from this analysis are presented in Figure \ref{fig:highVsLow}.
% It can be seen that the presence of events that made the interaction less dynamic (mostly reactive) is predominantly observed in the low customer satisfaction cases.
% The remaining event categories are present in both high and low customer satisfaction cases, however with a contrast between them.
% These contrasts are more pronounced in behavior categories ``a'' (robot is mostly reactive) and ``b" (operator is disoriented). 
% 
% Less prominent contrasts are observed under behavior categories ``c'' (customer ignores the robot) and ``d'' (customer is bored). 
%The presence of these events in high customer satisfaction may be due to the operator not being proficient at the use of the system.
%For instance, the operator may rely solely in the autogaze control to maintain the customer within the camera's field of view.
%This control although useful from the point of of view of the operator it may also convey an undesired social meaning, such as ``staring'' at the customer, making him/her uncomfortable.


% Figure \ref{fig:badBehavLowCS} presents the number of times one of these categories happened during each analyzed interaction, according to each of the experimental condition explained in Section \ref{subsec:conditions}. 
% As it can be seen the largest amount of occurence appeared on the ``no visualization and automatic gaze control''. 
% This result may be explained by the fact that the operator enables the automatic gaze control to keep the customer within the camera's field of view. 
% However, by doing it so and not having an appropriate spatial relationships representation, the operator must continuously disengage the automatic gaze control to look around for confirmation of the location of the different objects in the environment.
% This continuous jerky movement of the head and the body may convey an undesired meaning to the customer and thus reduce the customer's satisfaction of the service.
% 
% \begin{figure}[htb]
% \centering
% \includegraphics[width=1\columnwidth, scale= 0.6]{figs/numOccurBadBehavPerConditionLowCS}
% \caption{Total number of occurences of observed event categories per condition in low customer satisfaction scores.}
% \label{fig:badBehavLowCS}
% \end{figure}
% 
% As Figure \ref{fig:badBehavLowCS} shows, the experimental condition ``visualization of spatial relationships and automatic gaze control'' resulted with lowest number of occurrences of each of the categories previously mentioned.
% This result supports the concept that an appropriate visualization of the spatial relationships of the environment in combination with the proposed automatic gaze control increases the customer's satisfaction.
...
% The large difference between high and low customer satisfaction in the spatial awareness category may be due to the lack of proper visualization of spatial relationships. 
% Such poor visualization 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibliographystyle{IEEEtran}
\bibliography{moraSCM}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figs/andresProfilePic.eps}}]{Andres Mora}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figs/dylanPhoto.eps}}]{Dylan Glas}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figs/kandaPhoto.eps}}]{Takayuki Kanda}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figs/hagitaPhoto.eps}}]{Norihiro Hagita}
...
%\begin{IEEEbiographynophoto}{Dylan Glas}
%Biography text here.
...
%\begin{IEEEbiographynophoto}{Takayuki Kanda}
%Biography text here.
%\end{IEEEbiographynophoto}
