...
\title{An Experimental Approach to AUV Dynamic Adaptive Sampling}%\thanks{Grants or other notes 
...
\keywords{Optimal Sampling \and AUV \and kriging}
...
In research they are commonly used to carry hydrological, geophysical, and/or biological sensor payloads that are used to gather remote and in-situ data to aid the study of open and closed aquatic bodies \citep{stoker:exploration}, \citep{german:hydro}.
...
\subsection{Autonomous Sampling}
...
Introduction of the concept and our motivation to use it
Finish it with: for the purpose of this manuscript we have only covered the simple approach.
...
----> Talk about limitation that would leads us to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusions}
---> Summarize what we've done, and what we already started working on

---> How can the evaluation be improved? Dynamic Modeling
