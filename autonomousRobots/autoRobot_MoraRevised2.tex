...
\author{Andres~Mora~Vargas \and Colin~Ho \and Srikanth~Saripalli}

%\authorrunning{Short form of author list} % if too long for running head

\institute{A. Mora Vargas, C. Ho, and S. Saripalli \at
              School of Earth and Space Exploration, Arizona University, ISTB4-BLDG75
781 E. Terrace Rd., Tempe, Arizona, 85287-6004\\
              Tel.: +1-480-965-5081\\
              Fax: +1-480-965-8102\\
...
\begin{figure}[t]
	\includegraphics[width=\columnwidth, scale= 0.6]{iverAtPleasant} 
...
\begin{figure}[tp]
	\includegraphics[width=\columnwidth, scale= 1.0]{paperFlowExplanation}
...
For example, adaptive sampling algorithms have been developed to direct the path of single or multiple autonomous underwater vehicles towards locations of high probable data yield \citep{popa:adaptive}, and can be used in conjunction with existing sensor networks \citep{zhang:adaptive}. 
...
Adaptive sampling is an active area of research aiming to balance the trade-off between establishing the optimal dimension of a sampling grid, energy consumed by the AUV and the total duration of the mission.
...
In addition, the vehicle's navigation and control algorithms play an important role in the overall autonomy of the vehicle and the success of its missions \citep{dunbabin:catamaran}, \citep{bennett:behavior}. 
...
Researchers have also studied the advantages and disadvantages of multiple AUVs collaborating towards adaptive sampling of bodies of water.
...
Thus, a method of comparatively evaluating various sampling path strategies must be created and applied to various sampling path strategies across a wide range of scalar field data types. 
...
\centering
	\begin{subfigure}[t]{0.485\textwidth}
    	\centering
        \includegraphics[width=\columnwidth, scale= 1.0]{iverDescription1} %width=\columnwidth, scale= 1.0
     ...
     \begin{subfigure}[b]{0.30\textwidth}
    	\centering
        \includegraphics[width=\columnwidth, scale= 0.35]{iverSonde1} %width=\columnwidth, scale= 1.0
        \caption{YSI Sonde.}
        \label{fig:ysiSonde}
     \end{subfigure}
...
Lake Pleasant is a 30 km$^2$ artificial lake with a mean depth of 21 m created in 1927 to provide the entire Phoenix area with a constant supply of potable water.
...
An example of a sampled area and the sampling pattern made by our AUV platform is shown in Figure \ref{fig:fieldDeployments}. 
Figure \ref{fig:fieldDeployments}(a) shows a collection set of samples following the lawn-mower pattern acquired at the location seen in Figure \ref{fig:fieldDeployments}(b).
The approximate coordinates of the sampling location are $33$\textdegree $51' 55.66"$ N and $112$\textdegree$17' 45.01"$ W. 

In this particular experiment, the AUV collected 2258 samples over an area of approximately 70 m x 100 m. 
Comparatively speaking, our selected 7,000 m$^2$ region is larger than most sampled areas in the literature \citep{caldwell:reconfiguring}-\citep{cruz:thermoclines}. 
We selected this region due to two main factors: safety of the AUV and vicinity with an expected data-rich area. 
Given that Lake Pleasant is also a leisure location, constant boat traffic is a security concern during our experiments; this area had little or none of this traffic. 
This region also is within the vicinity of the lake's dam where concentrations of cholorophyll and algae are expected to be higher. 


From this area, a subset of the samples from 30-70 m northing and 30-70 m easting was selected, given that this region contained the highest density of samples.

\begin{figure}[t]
\centering
	\begin{subfigure}[t]{0.35\textwidth}
	\centering
		\includegraphics[width=\columnwidth, scale= 0.25]{samplingLocations}
	...
	\begin{subfigure}[t]{0.35\textwidth}
	\centering
		\includegraphics[width=\columnwidth, scale= 0.25]{samplingOverGoogleEarth}
...
\begin{figure*}[t]
	\begin{subfigure}[t]{\columnwidth}
    	\centering
        \includegraphics[scale= 0.30]{lawn_path_evenPlot} 
     ...
     \begin{subfigure}[t]{\columnwidth}
    	\centering
        \includegraphics[scale= 0.30]{lawn_pathPlot}
    ...
    \begin{subfigure}[b]{\columnwidth}
    	\centering
        \includegraphics[scale= 0.30]{Spiral_path_evenv2Plot}
        \caption{Even spiral}
     ...
     \begin{subfigure}[b]{\columnwidth}
    	\centering
        \includegraphics[scale= 0.30]{Spiral_path_v2Plot}
...
\begin{itemize}
    ...
    \item[2)] The vehicle’s total energy consumption is based upon the total distance it travels, and the total angle it turns during the sampling process.
...
\begin{figure*}[t]
	\begin{subfigure}[t]{0.3\textwidth}
    	\centering
        \includegraphics[scale= 0.30]{Isotropic_spiral_even_8x7_true} %width=\columnwidth, scale= 1.0
        \caption{Isotropic}
     ...
     \begin{subfigure}[t]{0.3\textwidth}
    	\centering
        \includegraphics[scale= 0.30]{Anisotropic1_spiral_even_8x7_true}
	...
	\begin{subfigure}[t]{0.3\textwidth}
    	\centering
        \includegraphics[scale= 0.30]{Anisotropic4_spiral_even_12x10_true}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[scale= 0.30]{Turbidity_spiral_even_10x9_true}
        \caption{Turbidity}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[scale= 0.30]{Cholorophyll_spiral_rand_9x8_true}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[scale= 0.30]{BlueGreenAlgae_lawn_rand_12x10_true}
...
Using the simple model approach presented in Section \ref{subsubsection:simpleApprach} as a starting point, we would like to argue for the feasibility of a new approach to model the dynamic behavior of the AUV used in this research: dynamic modeling. 
...
The dynamic modeling approach may simplify this procedure and to make it easier for non-roboticists to determine the dynamics of their robotic platform based on only the knowledge of the robot's inputs and outputs.

Dynamic modeling consists of an estimation of the dynamical model of the robot based on the selection of two known inputs and one output from the data acquired.
In our particular case, the two inputs of the estimation may be represented by the velocity and the heading of the vehicle measured by the on-board GPS -with a data acquisition frequency set to 2Hz and the output may be given by the total power consumed by the vehicle during the sampling mission. 
...
Another advantage of dynamic modeling is that it can be calculated through a wealth of methods.
...
\begin{figure}[htp]
	\centering
		\includegraphics[width=0.10\textwidth]{pathSeedingPositions}
...
\begin{figure*}
	...
	\begin{subfigure}[t]{0.35\textwidth}
		\centering
			\includegraphics[width=\columnwidth, scale= 0.25]{Isotropic_IMSE}
	...
	\begin{subfigure}[t]{0.35\textwidth}
		\centering
			\includegraphics[width=\columnwidth, scale= 0.25]{Anisotropic1_IMSE}
	...
	\begin{subfigure}[t]{0.35\textwidth}
		\centering
			\includegraphics[width=\columnwidth, scale= 0.25]{Anisotropic2_IMSE}
	...
	\begin{subfigure}[t]{0.35\textwidth}
		\centering
			\includegraphics[width=\columnwidth, scale= 0.25]{Turbidity_IMSE}
	...
	\begin{subfigure}[t]{0.35\textwidth}
		\centering
			\includegraphics[width=\columnwidth, scale= 0.25]{Cholorophyll_IMSE}
	...
	\begin{subfigure}[t]{0.35\textwidth}
		\centering
			\includegraphics[width=\columnwidth, scale= 0.25]{BlueGreenAlgae_IMSE}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\columnwidth, scale= 0.25]{averageEnergyConsumption}
...
\begin{figure*}[t]
	\centering
	\includegraphics[scale= 0.18]{costEval20Samples} %width=\columnwidth,
